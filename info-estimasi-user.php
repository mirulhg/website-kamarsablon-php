                ...
                <table class="table table-striped table-bordered table-hover table-responsive-sm">
                    ...
                    <tbody>
                        ...
                        while ($result = mysqli_fetch_array($query)) {
                                ...
                                <td scope='row'>
                                    <a href='info-estimasi-user-full.php?op=lihat&id=".$result['sts_id']."'><button type='submit' class='btn btn-primary btn-sm'><i class='bx bx-search-alt'>Lihat</i></button></a>
                                </td>
                            </td>
                            </tr>
                                ";
                    ...
                    <div>
                        ...
                        for($i=1;$i<=$pages ; $i++){
                        ?>
                        <a href="info-estimasi-user.php?halaman=<?php echo $i; ?>" style="text-decoration:none">   <u><?php echo $i; ?></u></a>
                        <?php
                        }
                        ?>
                    </div>
