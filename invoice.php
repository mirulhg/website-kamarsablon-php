...
class Invoice {
    ...
    public function saveInvoice($POST) {
        $sqlInsert = "INSERT INTO ".$this->invoiceOrderTable."(user_id, order_receiver_name, order_total_before_tax, order_total_tax, order_tax_per, order_total_after_tax, order_amount_paid, order_total_amount_due, note) 
    ...
    public function getInvoiceList(){
		$sqlQuery = "SELECT * FROM tbl_invoice ORDER BY inv_id DESC";
