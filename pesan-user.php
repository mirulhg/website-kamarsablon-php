...
<body>
    ...
    require_once 'sidebar-index-user.php';
...
<div class="container card card-body">
    <section class="pesan">
        <form action="includes/pesan-user.php" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php $id ?>">
        <fieldset>
        <div class="input-group mb-2 ">
            <label class="input-group-text" for="name" >Nama Pemesan : </label>
            <input type="text" name="name" class="baju" value="<?php echo $nama ?>" disabled required />
        </div>
        <div class="input-group mb-2">
    ...
    mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);
                if (isset($_GET["error"])) {
                    if ($_GET["error"] == "emptyinput") {
                        ...
                        echo "<p>PESANAN SUDAH DISUBMIT</p>";
                    }
